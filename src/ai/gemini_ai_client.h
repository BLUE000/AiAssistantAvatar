...
class GeminiAIClient : public IAIClient {
    Q_OBJECT
private:
    QNetworkAccessManager *m_networkManager;
    QString m_apiKey;
    QString m_model;           // デフォルト: "gemini-2.5-flash"
...
public:
    explicit GeminiAIClient(QObject *parent = nullptr);
    ~GeminiAIClient() override;
    ...
    QString clientId() const override { return QStringLiteral("gemini"); }
